<template>
    <div class="flex flex-col justify-center items-center fixed bottom-0 left-0 w-full max-h-11 bg-gray-900 font-montserrat text-xs font-light text-white transition duration-300"
         :class="{
